...
<article class="project-page">
  ...
  <header class="project-hero"><p class="project-kicker">FACIAL ANALYSIS · MAY 2024 — MAY 2025</p><h1>MakeupVision</h1><p class="project-deck">A virtual-makeup vision pipeline combining face detection, dense landmarks, semantic facial regions, and localized texture transfer.</p><div class="project-tags"><span class="tag-purple">Facial Analysis</span><span class="tag-pink">AI + Beauty</span></div><img src="/assets/images/projects/makeupvision-hero.webp" alt="Conceptual computer-vision pipeline for virtual makeup"></header>
